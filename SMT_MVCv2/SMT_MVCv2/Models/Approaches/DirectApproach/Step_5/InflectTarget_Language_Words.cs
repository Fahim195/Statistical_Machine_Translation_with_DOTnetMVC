...
namespace SMT_MVCv2.Models.Approaches.DirectApproach.Step_5
{
    public class InflectTarget_Language_Words
    {
        ...
        public string TargetLanguage_REpresentation(string[] Words, string[] PoSTags, string[] ReOrderedMorphines, string Subject, string Subject_tag, string Verb, string VerbTag, DataSet LookupDataSet)
        {
            ...
            StringBuilder sb = new StringBuilder(InflectedTargetLanguage);
            if (InflectedTargetLanguage.Contains("টিটি")) { InflectedTargetLanguage.Replace("টিটি", "টি"); }
            else if (InflectedTargetLanguage.Contains("টি টি"))
            {
                sb.Replace("টি টি", "টি ");
            }
            sb.Replace(@"\s+", " ");
            InflectedTargetLanguage = sb.ToString();
