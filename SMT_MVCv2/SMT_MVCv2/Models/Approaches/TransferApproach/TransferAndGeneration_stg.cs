using SMT_MVCv2.Models.Ambiguity;
using SMT_MVCv2.Models.DAL;
using System;
...
namespace SMT_MVCv2.Models.Approaches.TransferApprach
{
    public class TransferAndGeneration_stg
    {
        ...
        public void generateSentence(string[] objects, string[] object_postags, string[] WORDS)
        {
            ...
            if (sentence.Contains("টিটি")) { sentence.Replace("টিটি", "টি"); }
            else if (sentence.Contains("টি টি"))
            {                             
                sb.Replace("টি টি", "টি ");                
            }
            sb.Replace(@"\s+", " ");
        ...
        public string IdetifyObjects_NotRelatedWith_Preposition(int PrepositionStructure_start, int PrepositionStructure_end, string[] WORDS, DataTable meaningDT, string SUBJECT, string VERB,int MainsubjectIndex)
        {
            string objects = "", objectsSingle = "";
            if (MainsubjectIndex >=  0 ) { searchInitial_index = MainsubjectIndex; }
